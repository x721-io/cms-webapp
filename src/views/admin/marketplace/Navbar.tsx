    ...
    <div className="flex justify-between gap-4 py-8">
      ...
      <div className="">
        <Button
          ...
          className={
            isFiltersVisible
              ? "h-[56px] bg-white shadow tablet:h-[55px] desktop:h-[55px]"
              : `bg-surface-soft h-[56px] tablet:h-[55px] desktop:h-[55px]`
          }
          scale="lg"
          variant="secondary"
        >
          Filters
          <span className="bg-surface-medium rounded-lg p-1">
      ...
      <div>
        <Dropdown
          label=""
          renderTrigger={() => (
            <div className="bg-surface-soft flex h-full cursor-pointer items-center justify-center gap-3 rounded-2xl p-3">
              {sortOption.name}
            </div>
          )}
        >
